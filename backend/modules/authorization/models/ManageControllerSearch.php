...
/**
 * ManageControllerSearch represents the model behind the search form of `backend\modules\authorization\models\ManageController`.
 */
class ManageControllerSearch extends ManageController
{
    /**
     * {@inheritdoc}
     */
